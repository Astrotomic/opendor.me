<div class="bg-white">
    <div class="py-8 px-4 mx-auto max-w-7xl divide-y-2 divide-gray-200 sm:py-16 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 gap-8 justify-center py-4 mt-6 md:grid-cols-3 lg:grid-cols-4">
            <a href="https://pingping.io" class="flex flex-col justify-center items-center py-6 px-4 space-y-2">
                <img class="max-h-12" src="{{ asset('images/sponsors/pingping.svg') }}" alt="PingPing">
                <span class="text-lg font-medium text-center">PingPing</span>
            </a>
            <a href="https://plausible.io" class="flex flex-col justify-center items-center py-6 px-4 space-y-2">
                <img class="max-h-12" src="{{ asset('images/sponsors/plausible.png') }}" alt="Plausible">
                <span class="text-lg font-medium text-center">Plausible</span>
            </a>
            <a href="https://www.laravel-enlightn.com" class="flex flex-col justify-center items-center py-6 px-4 space-y-2">
