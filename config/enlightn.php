...
return [
    ...
    */
    ...
    'exclude_analyzers' => [
        ...
        FallbackRouteAnalyzer::class,
        UnguardedModelsAnalyzer::class,
        StorageLinkAnalyzer::class,
        ComposerPackagePublishAnalyzer::class,
